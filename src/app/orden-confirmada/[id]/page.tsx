...
export default function OrdenConfirmadaPage() {
  ...
  const handleWhatsApp = () => {
    ...
    const msg = encodeURIComponent(
      `Hola 👋, tengo una consulta sobre mi pedido #${numeroOrden} en Street Candy.`
    );
        ...
        <div className="max-w-lg w-full">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sc-muted text-base leading-relaxed">
              Gracias por tu compra en Street Candy. Hemos recibido tu pedido y lo estamos procesando.
            </p>
          </div>
