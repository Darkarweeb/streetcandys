  ...
  const footerLinks = [
    {
      ...
      links: [
        ...
        { label: 'Gomitas', href: '/productos?categoria=gummies' },
        { label: 'Flor', href: '/productos?categoria=flower' },
        { label: 'Comestibles', href: '/productos?categoria=edibles' },
        { label: 'Bebidas', href: '/productos?categoria=beverages' },
        { label: 'Pre-Rolls', href: '/productos?categoria=pre-rolls' },
        { label: 'Concentrados', href: '/productos?categoria=concentrates' },
        { label: 'Paquetes/Combos', href: '/productos?categoria=bundles' },
      ],
    },
    {
      heading: 'APRENDE',
      links: [
        { label: 'Legalidad', href: '#learn' },
        { label: 'Cannabinoides', href: '#learn' },
        { label: 'Sobre Nosotros', href: '#about' },
        { label: 'Calidad', href: '#learn' },
    ...
    },
    {
      heading: 'RECOMPENSAS',
      links: [
        { label: 'Cómo Funciona', href: '#rewards' },
        { label: 'Balance de Puntos', href: '#rewards' },
        { label: 'Da y Recibe', href: '#rewards' },
        { label: 'Formas de Ganar', href: '#rewards' },
        { label: 'Formas de Canjear', href: '#rewards' },
      ],
    },
    {
      heading: 'Legal',
