...
export default function CartDrawer({
  ...
  // For Costa Rica: always show WhatsApp button when there are items (regardless of settings)
  const showCRWhatsApp = activeCountry === 'CR' && availableItems.length > 0;
  ...
  const handleWhatsAppCheckout = async () => {
    ...
    // Use settings phone if available, otherwise fall back to hardcoded business number
    const rawPhone = settings.phone?.replace(/\D/g, '') || '573115397983';
              ...
              {showCRWhatsApp && (
                <>
                  ...
                  >
                    ...
                    {waLoading2 ? 'Preparando pedido...' : 'Completar pedido por WhatsApp'}
                  </button>
