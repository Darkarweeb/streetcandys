...
echo "🍬 StreetCandys — Capacitor Mobile Setup"
echo "========================================="
...
if [ ! -f "capacitor.config.ts" ]; then
  ...
  npx cap init "StreetCandys" "shop.streetcandys.app" --web-dir out
fi
...
echo ""
echo "See MOBILE_BUILD_GUIDE.md for full build instructions."
